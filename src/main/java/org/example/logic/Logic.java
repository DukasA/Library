...
public class Logic {
    ...
    //private static final String SELECT_BOOKS_BY_PARAMETERS = "SELECT * FROM `books` WHERE title LIKE ? OR author LIKE ? OR isbn LIKE ?";
    ...
    //private static final String SELECT_RENTED_BOOKS = "SELECT * FROM `books` WHERE status = 'rented'";
            ...
            while (rs.next()) {
                ...
                if (status.equals("rented")) {
                    ...
                    if (rentalRs.next()) {
                        ...
                        //System.out.printf("%s by %s, ISBN: %s, Status: %s, Rented by %s on %s, due on %s%n",
                        //        title, author, isbn, status, userName, rentalDate, dueDate);
                    ...
                    //System.out.printf("%s by %s, ISBN: %s, Status: %s%n", title, author, isbn, status);
                }
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
    ...
    /*public static void findBooksByParameters() {
        System.out.print("Enter name of the book or author or isbn: ");
    ...
    /*private static void findBooksByParameters() {
        System.out.print("Enter name of the book or author or isbn: ");
        String query = scanner.nextLine();
        try {
            PreparedStatement stmt = conn.prepareStatement(SELECT_BOOKS_BY_PARAMETERS);
            ...
            while (rs.next()) {
                ...
                System.out.printf("%s by %s, ISBN: %s, Availability: %s%n", title, author, isbn, isAvailable);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
